  ...
  <PrivacyPolicyWrapper>
    ...
    <FlexWrapper>
      <StyledContent>
        ...
        <p>
          CoinieTrade ("us", "we", or "our") operates the
          https://www.coinietrade.com/ website and the CoinieTrade mobile
        ...
        <p>
          ...
          <a href="https://termsfeed.com/privacy-policy/generator/">
            generated by the Privacy Policy Generator from TermsFeed
          </a>
          .
        </p>
        ...
        <ul>
          <li>
            ...
            <p>
              Service means the https://www.coinietrade.com/ website and the
              CoinieTrade mobile application operated by CoinieTrade
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          ...
          <li>API Secrets and keys for exchange sites</li>
        </ul>
        ...
        <p>CoinieTrade uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          CoinieTrade will take all steps reasonably necessary to ensure that
        ...
        <p>
          CoinieTrade may disclose your Personal Data in the good faith belief
          that such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of CoinieTrade</li>
          <li>
