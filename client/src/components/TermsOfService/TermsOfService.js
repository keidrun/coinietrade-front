    ...
    <div className={styles.flex_wrapper}>
      <div className={styles.content}>
        ...
        <p>
          ...
          Conditions", "Terms Of Service") carefully before using the
          https://www.coinietrade.com/ website and the CoinieTrade mobile
          application (the "Service") operated by CoinieTrade ("us", "we", or
          "our").
        </p>
        ...
        <p>
          ...
          access the Service. This Terms and Conditions agreement for
          CoinieTrade is{' '}
        ...
        <p>
          ...
          that are not owned or controlled by CoinieTrade.
        </p>

        <p>
          CoinieTrade has no control over, and assumes no responsibility for,
          the content, privacy policies, or practices of any third party web
          sites or services. You further acknowledge and agree that CoinieTrade
